...
from menu.models import Restaurant  # Import Restaurant model
...
def register_user(request):
    try:
        ...
        try:
            ...
            # Store phone number temporarily in last_name field
            user.last_name = phone_number
            user.save()
            
            # CREATE RESTAURANT PROFILE - THIS IS THE NEW PART
            ...
            messages.success(request, f'Account created successfully! Your menu will be available at: /{restaurant.slug}-menu/')
            return render(request, 'user/signup.html')
